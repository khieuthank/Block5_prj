    ...
    <body style="">
        ...
        <div class="humberger__menu__wrapper">
            ...
            <div class="header__top__right__social">
                <a href="https://www.facebook.com/kin2901"><i class="fa fa-facebook"></i></a>
            ...
            <div class="humberger__menu__contact">
                <ul>
                    <li><i class="fa fa-envelope"></i>kientthe160037@gmai.com</li>
                    <li>Shop via FB, hỗ trợ fb 24/7</li>
                </ul>
            </div>
        </div>
        <!-- Humberger End -->
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="header__top__left">
                                <ul>
                                    ...
                                    <li>Shop bán Via Facebook, hỗ trợ Facebook 24/7.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer__about">
                            <div class="footer__about__Via">
                                <a href="./Home.html"><img src="img/logo.jpg" alt=""></a>
                            </div>
                            <ul>
                                <li>Address: Thái Bình</li>
